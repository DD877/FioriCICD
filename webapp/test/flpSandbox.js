		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comppgfioricicd-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comppgfioricicd-display": {
								"semanticObject": "comppgfioricicd",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ppg.fioricicd",
									"url": sap.ui.require.toUrl("com/ppg/fioricicd")
								}
							}
						}
					}
